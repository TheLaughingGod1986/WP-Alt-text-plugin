...
$bbai_primary_price = $bbai_on_authenticated_free
    ? sprintf(
        ...
        $bbai_currency['symbol'],
        number_format($bbai_starter_monthly, 2)
    )
    : __('Subscription settings', 'beepbeep-ai-alt-text-generator');

$bbai_decision_eyebrow = $bbai_on_authenticated_free
    ? __('Best for small sites', 'beepbeep-ai-alt-text-generator')
    : __('Most popular', 'beepbeep-ai-alt-text-generator');
        ...
        <div class="bbai-upgrade-modal__body">
            <section class="bbai-upgrade-modal__view bbai-upgrade-modal__view--default" data-bbai-upgrade-view-panel="default">
                    ...
                    <div class="bbai-upgrade-modal__action-meta">
                        ...
                        <?php elseif ( $bbai_on_authenticated_free ) : ?>
                            <button type="button"
                                    ...
                                    data-plan="starter"
                                    data-price-id="<?php echo esc_attr($bbai_starter_price_id); ?>"
                                    data-fallback-url="<?php echo esc_url($bbai_stripe_links['starter']); ?>">
                                <?php echo esc_html($bbai_primary_button_label); ?>
                            </button>
                            <p class="bbai-upgrade-modal__risk-note"><?php esc_html_e('100 monthly images. Great for small business websites. Cancel anytime.', 'beepbeep-ai-alt-text-generator'); ?></p>
                        <?php else : ?>
                ...
                <div class="bbai-upgrade-modal__action-card bbai-upgrade-modal__action-card--secondary">
                    <div class="bbai-upgrade-modal__action-copy">
                        <p class="bbai-upgrade-modal__section-label"><?php esc_html_e('Best value', 'beepbeep-ai-alt-text-generator'); ?></p>
                        <p class="bbai-upgrade-modal__credit-title"><?php esc_html_e('Growth', 'beepbeep-ai-alt-text-generator'); ?></p>
                        <p class="bbai-upgrade-modal__decision-desc"><?php esc_html_e('Get 1,000 monthly images, bulk processing, and Autopilot.', 'beepbeep-ai-alt-text-generator'); ?></p>
                    </div>
                    <div class="bbai-upgrade-modal__action-meta bbai-upgrade-modal__action-meta--secondary">
                        <p class="bbai-upgrade-modal__action-price bbai-upgrade-modal__action-price--secondary">
                            <?php
                            echo esc_html(
                                sprintf(
                        ...
                        <p class="bbai-upgrade-modal__risk-note"><?php esc_html_e('Includes bulk processing and Autopilot. Cancel anytime.', 'beepbeep-ai-alt-text-generator'); ?></p>
                    </div>
                </div>
                <?php endif; ?>
            ...
            <section id="bbai-upgrade-plan-comparison" class="bbai-upgrade-modal__view bbai-upgrade-modal__view--compare" data-bbai-upgrade-view-panel="compare" data-bbai-upgrade-plan-comparison hidden>
                ...
                <div class="bbai-upgrade-modal__compare-grid">
                    ...
                    <div class="bbai-pricing-card bbai-pricing-card--starter">
                        <div class="bbai-pricing-card__badges">
                            <span class="bbai-pricing-card__badge bbai-pricing-card__badge--growth"><?php esc_html_e('Best for small sites', 'beepbeep-ai-alt-text-generator'); ?></span>
                            <?php if ( $bbai_is_starter_plan ) : ?>
                                <span class="bbai-pricing-card__status"><?php esc_html_e('Current plan', 'beepbeep-ai-alt-text-generator'); ?></span>
                            <?php endif; ?>
                        </div>
                        <div class="bbai-pricing-card__intro">
                            <h3 class="bbai-pricing-card__title"><?php esc_html_e('Starter', 'beepbeep-ai-alt-text-generator'); ?></h3>
                            <p class="bbai-pricing-card__descriptor"><?php esc_html_e('For small business websites', 'beepbeep-ai-alt-text-generator'); ?></p>
                        </div>
                        <ul class="bbai-pricing-card__features">
                            <li>
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
                                ...
                                <?php esc_html_e('100 monthly images', 'beepbeep-ai-alt-text-generator'); ?>
                            </li>
                            <li>
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
                                    <path d="M13 4L6 11L3 8" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                                <?php esc_html_e('1 WordPress site', 'beepbeep-ai-alt-text-generator'); ?>
                            </li>
                            <li>
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
                                    <path d="M13 4L6 11L3 8" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                                <?php esc_html_e('Cancel anytime', 'beepbeep-ai-alt-text-generator'); ?>
                            </li>
                        </ul>
                        <div class="bbai-pricing-card__footer">
                            <div class="bbai-pricing-card__price-stack">
                                <div class="bbai-pricing-card__price">
                                    <span class="bbai-pricing-card__currency"><?php echo esc_html($bbai_currency['symbol']); ?></span>
                                    <span class="bbai-pricing-card__amount"><?php echo esc_html(number_format($bbai_starter_monthly, 2)); ?></span>
                                    <span class="bbai-pricing-card__period"><?php esc_html_e('/month', 'beepbeep-ai-alt-text-generator'); ?></span>
                                </div>
                                <div class="bbai-pricing-card__limit"><?php esc_html_e('100 images/month', 'beepbeep-ai-alt-text-generator'); ?></div>
                            </div>
                            <?php if ( $bbai_is_starter_plan ) : ?>
                            ...
                            <?php elseif ( $bbai_on_authenticated_free ) : ?>
                                <button type="button"
                                        ...
                                        data-price-id="<?php echo esc_attr($bbai_starter_price_id); ?>"
                                        data-fallback-url="<?php echo esc_url($bbai_stripe_links['starter']); ?>">
                                    <?php esc_html_e('Upgrade to Starter', 'beepbeep-ai-alt-text-generator'); ?>
                                </button>
                            <?php else : ?>
                                <a href="<?php echo esc_url($bbai_billing_url); ?>" class="bbai-btn bbai-btn-secondary bbai-btn-lg bbai-btn-block bbai-pricing-card__btn">
                                    <?php esc_html_e('Manage billing', 'beepbeep-ai-alt-text-generator'); ?>
                    ...
                    <div class="bbai-pricing-card bbai-pricing-card--growth">
                        <div class="bbai-pricing-card__badges">
                            <span class="bbai-pricing-card__badge bbai-pricing-card__badge--growth"><?php esc_html_e('Best value', 'beepbeep-ai-alt-text-generator'); ?></span>
                        ...
                        <ul class="bbai-pricing-card__features">
                            <li>
                                ...
                                <?php esc_html_e('1,000 monthly images', 'beepbeep-ai-alt-text-generator'); ?>
                            </li>
                            <li>
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
                                    <path d="M13 4L6 11L3 8" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <li>
                                ...
                                <?php esc_html_e('Autopilot for new uploads', 'beepbeep-ai-alt-text-generator'); ?>
                            </li>
                            <li>
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
                                    <path d="M13 4L6 11L3 8" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
