...
trait Core_Admin_UI {
	...
	public function render_settings_page() {
		...
		?>
		<div class="wrap bbai-wrap bbai-modern bbai-modern--no-header">
			<?php
			// Custom dark header removed during the premium refinement pass.
			// The WordPress admin sidebar is now the only navigation system.
			// Account/upgrade/logout actions are reachable from the dashboard
			// surface (settings tab, in-context CTAs).
			?>
