	...
	?>
				...
				<div class="bbai-container bbai-settings-page bbai-settings-page--gated">
					...
					<div class="bbai-hero bbai-hero--neutral bbai-sg-hero">
						<div class="bbai-sg-hero__text">
							<h1 class="bbai-sg-hero__title"><?php esc_html_e( 'Control how OpptiAI writes your ALT text', 'beepbeep-ai-alt-text-generator' ); ?></h1>
						...
						<div class="bbai-sg-hero__actions">
							...
							<a class="bbai-sg-hero__skip" href="<?php echo esc_url( add_query_arg( array( 'tab' => 'settings' ) ) ); ?>">
					...
					<div class="bbai-card bbai-settings-upgrade-block">
						...
						<div class="bbai-settings-upgrade-block__actions">
							...
							<a class="bbai-btn bbai-btn-secondary" href="<?php echo esc_url( add_query_arg( array( 'tab' => 'settings' ) ) ); ?>">
								<?php esc_html_e( 'Continue with local settings', 'beepbeep-ai-alt-text-generator' ); ?>
							</a>
						</div>
					</div>
			...
			<div class="bbai-container bbai-settings-page">
				...
				if ( isset( $this->api_client ) ) {
					...
					if ( is_array( $bbai_live ) && ! empty( $bbai_live ) ) {
						\BeepBeepAI\AltTextGenerator\Usage_Tracker::update_usage( $bbai_live ); }
				}
				...
				<div class="bbai-hero bbai-hero--neutral bbai-dashboard-header-section bbai-page-section">
					...
					<p class="bbai-dashboard-subtitle bbai-page-subtitle"><?php esc_html_e( 'Configure OpptiAI and control how ALT text is generated for your media library.', 'beepbeep-ai-alt-text-generator' ); ?></p>
				...
				<div class="bbai-card bbai-settings-card bbai-page-section">
					...
					<div class="bbai-settings-account-actions">
						<div class="bbai-settings-account-action-info">
							...
							<?php
					elseif ( $bbai_is_authenticated_for_account ) :
