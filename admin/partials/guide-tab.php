...
$bbai_library_missing_url = add_query_arg(
	array(
		'page'   => 'bbai',
		'tab'    => 'library',
		'status' => 'missing',
...
$bbai_settings_url        = add_query_arg(
	array(
		'page' => 'bbai',
		'tab'  => 'settings',
	),
...
<div class="bbai-guide-page">
	...
	<div class="bbai-guide-header bbai-page-section">
		...
		<p class="bbai-page-subtitle"><?php esc_html_e( 'Learn how scanning, generation, credits, and accessibility workflows work in OpptiAI.', 'beepbeep-ai-alt-text-generator' ); ?></p>
	</div>
			...
			<div class="bbai-guide-step bbai-guide-step-card">
				...
				<div class="bbai-guide-step-content">
					...
					<ul class="bbai-guide-step-bullets">
						...
						<li><?php esc_html_e( 'OpptiAI will analyze all images', 'beepbeep-ai-alt-text-generator' ); ?></li>
