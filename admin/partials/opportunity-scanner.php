...
$bbai_coverage = isset( $bbai_coverage ) && is_array( $bbai_coverage ) ? $bbai_coverage : array();
...
$bbai_library_url         = add_query_arg( array( 'page' => 'bbai-library' ), admin_url( 'admin.php' ) );
...
$bbai_default_summary      = __( 'Follow this simple workflow to use OpptiAI:', 'beepbeep-ai-alt-text-generator' );
$bbai_generate_disabled    = 0 === $bbai_missing_images;
$bbai_workflow_steps       = array(
	array(
...
<section class="bbai-dashboard-card bbai-opportunity-scanner" aria-labelledby="bbai-opportunity-title">
	<article class="bbai-opportunity-scanner__card">
		<header class="bbai-card__header">
			<h3 id="bbai-opportunity-title" class="bbai-opportunity-scanner__title"><?php esc_html_e( 'How to use OpptiAI', 'beepbeep-ai-alt-text-generator' ); ?></h3>
