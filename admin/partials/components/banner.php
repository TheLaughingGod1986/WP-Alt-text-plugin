...
$bbai_primary       = isset( $bbai_ui['primaryCTA'] ) && is_array( $bbai_ui['primaryCTA'] ) ? $bbai_ui['primaryCTA'] : array();
$bbai_secondary     = isset( $bbai_ui['secondaryCTA'] ) && is_array( $bbai_ui['secondaryCTA'] ) ? $bbai_ui['secondaryCTA'] : array();
$bbai_extra_class   = trim( (string) ( $bbai_ui['extra_class'] ?? '' ) );
$bbai_subtext_attrs = isset( $bbai_ui['description_attrs'] ) && is_array( $bbai_ui['description_attrs'] ) ? $bbai_ui['description_attrs'] : array();
...
if ( ! empty( $bbai_primary['label'] ) ) {
	...
	bbai_ui_render(
		...
		array(
			...
			'attributes' => isset( $bbai_primary['attributes'] ) && is_array( $bbai_primary['attributes'] ) ? $bbai_primary['attributes'] : array(),
		)
	);
...
if ( ! empty( $bbai_secondary['label'] ) ) {
	...
	bbai_ui_render(
		...
		array(
			...
			'attributes' => isset( $bbai_secondary['attributes'] ) && is_array( $bbai_secondary['attributes'] ) ? $bbai_secondary['attributes'] : array(),
		)
	);
...
bbai_ui_render(
	'bbai-banner',
	array( 'command_hero' => bbai_banner_inline_payload_to_command_hero( $bbai_payload ) )
);
