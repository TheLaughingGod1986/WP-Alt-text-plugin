...
$bbai_command_hero = isset( $bbai_ui['command_hero'] ) && is_array( $bbai_ui['command_hero'] )
	...
	: ( isset( $bbai_command_hero ) && is_array( $bbai_command_hero ) ? $bbai_command_hero : array() );
...
$bbai_ch_heading_tag = in_array( $bbai_ch_ht_raw, array( 'h1', 'h2' ), true ) ? $bbai_ch_ht_raw : 'h1';
...
$bbai_ch_inline_stats = isset( $bbai_ch['inline_stats'] ) && is_array( $bbai_ch['inline_stats'] ) ? $bbai_ch['inline_stats'] : array();
...
$bbai_ch_icon_attr_pairs = array( 'class="bbai-dashboard-hero__icon bbai-banner__icon bbai-page-hero__icon"', 'aria-hidden="true"' );
...
$bbai_ch_headline_pairs = array( 'class="bbai-dashboard-hero__headline bbai-banner__headline"' );
...
$bbai_ch_subtext_pairs = array( 'class="bbai-dashboard-hero__subtext bbai-banner__subtext"', 'data-bbai-hero-subtext="1"' );
...
$bbai_ch_banner_variant = isset( $bbai_ch['banner_variant'] ) && in_array( (string) $bbai_ch['banner_variant'], array( 'success', 'warning', 'info', 'neutral' ), true )
	? (string) $bbai_ch['banner_variant']
	: ( in_array( $bbai_ch_tone, array( 'attention', 'paused', 'setup' ), true ) ? 'warning' : 'success' );
