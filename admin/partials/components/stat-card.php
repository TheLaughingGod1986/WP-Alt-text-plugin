...
$bbai_density_class = 'compact' === $bbai_density ? ' bbai-ui-stat-card--compact' : '';
$bbai_root = trim('bbai-ui-stat-card bbai-stat-card bbai-analytics-metric-card bbai-dashboard-surface-card' . $bbai_density_class . ' ' . $bbai_root_extra);
