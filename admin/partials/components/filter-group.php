...
$bbai_fg_items      = isset( $bbai_ui['items'] ) && is_array( $bbai_ui['items'] ) ? $bbai_ui['items'] : array();
...
$bbai_fg_root_attrs = isset( $bbai_ui['root_attrs'] ) && is_array( $bbai_ui['root_attrs'] ) ? $bbai_ui['root_attrs'] : array();
...
foreach ( $bbai_fg_items as $bbai_item ) {
	...
	$bbai_item_attrs  = isset( $bbai_item['attrs'] ) && is_array( $bbai_item['attrs'] ) ? $bbai_item['attrs'] : array();
	$bbai_label_attrs = isset( $bbai_item['label_attrs'] ) && is_array( $bbai_item['label_attrs'] ) ? $bbai_item['label_attrs'] : array();
	$bbai_count_attrs = isset( $bbai_item['count_attrs'] ) && is_array( $bbai_item['count_attrs'] ) ? $bbai_item['count_attrs'] : array();
	...
	if ( 'navigate' === $bbai_fg_mode ) {
		...
		<?php $bbai_open( 'span', $bbai_merge_attrs( array( 'class' => 'bbai-filter-group__label' ), $bbai_label_attrs ) ); ?>
	...
	$bbai_attrs       = $bbai_merge_attrs( $bbai_attrs, $bbai_item_attrs );
	$bbai_count_attrs = $bbai_merge_attrs( array( 'class' => 'bbai-filter-group__count' ), $bbai_count_attrs );
