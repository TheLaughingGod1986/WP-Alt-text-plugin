...
$bbai_uic_stack = isset( $bbai_ins_stack_lines ) && is_array( $bbai_ins_stack_lines ) ? $bbai_ins_stack_lines : array();
$bbai_uic_chips = isset( $bbai_ins_chips ) && is_array( $bbai_ins_chips ) ? $bbai_ins_chips : array();
$bbai_uic_tone  = isset( $bbai_ins_tone ) ? (string) $bbai_ins_tone : 'healthy';
if ( ! in_array( $bbai_uic_tone, array( 'healthy', 'warning', 'danger' ), true ) ) {
