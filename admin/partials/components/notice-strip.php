...
$bbai_variant    = in_array( $bbai_variant_in, array( 'success', 'warning', 'info', 'neutral' ), true ) ? $bbai_variant_in : 'neutral';
...
$bbai_root = array( 'bbai-ui-notice-strip', 'bbai-ui-notice-strip--' . $bbai_variant );
