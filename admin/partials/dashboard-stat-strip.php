...
$bbai_li_pills    = is_array( $bbai_li_state['pills'] ?? null ) ? $bbai_li_state['pills'] : array();
$bbai_li_usage    = is_array( $bbai_li_state['usage'] ?? null ) ? $bbai_li_state['usage'] : array();
...
>
	...
	<?php if ( ! empty( $bbai_li_pills ) ) : ?>
		...
		>
			<?php
			foreach ( $bbai_li_pills as $bbai_li_pill ) :
