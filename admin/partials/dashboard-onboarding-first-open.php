...
if ( ! in_array( $bbai_ob_phase, array( 'pre_scan', 'post_scan' ), true ) ) {
	return;
}
...
$bbai_missing_library_ob    = add_query_arg(
	array(
		'page'   => 'bbai-library',
		'status' => 'missing',
	),
...
$bbai_library_ob            = add_query_arg( array( 'page' => 'bbai-library' ), admin_url( 'admin.php' ) );
?>
<section
