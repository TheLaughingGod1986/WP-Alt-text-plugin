    ...
    <div class="bbai-analytics-container">
        ...
        <div class="bbai-premium-metrics-grid bbai-mb-6">
            ...
            <div class="bbai-premium-card bbai-metric-card">
                ...
                <div class="bbai-metric-value" style="color: #10B981;"><?php echo esc_html($bbai_alt_coverage_display); ?></div>
                <div class="bbai-metric-sublabel"><?php esc_html_e('ALT Coverage', 'beepbeep-ai-alt-text-generator'); ?></div>
                <div class="bbai-metric-description">
                    <?php esc_html_e('Images now have descriptive ALT text.', 'beepbeep-ai-alt-text-generator'); ?>
                </div>
            </div>
        ...
        <!-- ALT Coverage Trend Section -->
        <div class="bbai-card bbai-mb-6">
            <div class="bbai-card-header bbai-card-header--with-action">
                <h2 class="bbai-card-title"><?php esc_html_e('ALT Coverage Trend', 'beepbeep-ai-alt-text-generator'); ?></h2>
            ...
            <div class="bbai-card-body">
                ...
                <?php endif; ?>
                <p class="bbai-text-xs bbai-text-gray-500 bbai-mt-2"><?php esc_html_e('ALT Coverage', 'beepbeep-ai-alt-text-generator'); ?></p>
                <p class="bbai-chart-insight bbai-text-sm bbai-text-slate-600 bbai-mt-3"><?php esc_html_e('Your media library now has full ALT text coverage.', 'beepbeep-ai-alt-text-generator'); ?></p>
            </div>
        </div>
        ...
        <div class="bbai-analytics-bottom-row bbai-grid bbai-grid-2 bbai-mb-6">
            <!-- Before & After Card -->
            <div class="bbai-card bbai-dashboard-card">
                ...
                <div class="bbai-comparison-grid">
                    ...
                    <div class="bbai-comparison-item bbai-comparison-item--after">
                        ...
                        <div style="display: flex; align-items: center; gap: 6px; margin-top: 8px; font-size: 11px; color: #6B7280;">
                            ...
                            <?php esc_html_e('Improved accessibility and image SEO', 'beepbeep-ai-alt-text-generator'); ?>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="bbai-activity-timeline" id="bbai-activity-timeline">
                    ...
                    <div class="bbai-activity-empty" id="bbai-activity-empty" style="display: none;">
                        ...
                        <p class="bbai-empty-description">
                            <?php esc_html_e('Activity will appear here as new ALT text is generated.', 'beepbeep-ai-alt-text-generator'); ?>
                        </p>
                        <button type="button" class="bbai-btn bbai-btn-primary bbai-btn-sm bbai-mt-4" data-action="rescan-media-library">
