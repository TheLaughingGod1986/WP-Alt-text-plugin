...
$bbai_rs_tel     = isset( $bbai_rs['telemetry'] ) && is_array( $bbai_rs['telemetry'] ) ? $bbai_rs['telemetry'] : array();
...
$bbai_rs_primary   = $bbai_rs['primary'] ?? array();
$bbai_rs_secondary = $bbai_rs['secondary'] ?? array();
