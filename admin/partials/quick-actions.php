...
$bbai_library_optimized_url    = add_query_arg(
	array(
		'page'   => 'bbai-library',
		'status' => 'optimized',
	),
...
$bbai_library_needs_review_url = function_exists( 'bbai_alt_library_needs_review_url' ) ? bbai_alt_library_needs_review_url() : add_query_arg(
	array(
		'page'   => 'bbai-library',
		'status' => 'needs_review',
	),
