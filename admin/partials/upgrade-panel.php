...
$bbai_panel = isset( $bbai_panel ) && is_array( $bbai_panel ) ? $bbai_panel : array();
...
$bbai_up_primary   = is_array( $bbai_panel['primary'] ?? null ) ? $bbai_panel['primary'] : array();
$bbai_up_secondary = is_array( $bbai_panel['secondary'] ?? null ) ? $bbai_panel['secondary'] : array();
