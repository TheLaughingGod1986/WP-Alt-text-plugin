...
<div class="bbai-ui-kit bbai-container" data-bbai-ui-kit="1">
	...
	<section class="bbai-ui-kit__section" id="bbai-ui-kit-composed" aria-labelledby="bbai-ui-kit-composed-h">
		...
		<div class="bbai-ui-kit__group">
			...
			<?php bbai_ui_render( 'bbai-banner', array( 'command_hero' => $bbai_kit_hero ) ); ?>
		</div>
		...
		<div class="bbai-ui-kit__group">
			...
			bbai_ui_render(
				...
				array(
					'phase'      => 'open',
					'aria_label' => __( 'Preview metrics', 'beepbeep-ai-alt-text-generator' ),
				)
			);
			bbai_ui_render(
				'stat-card',
			...
			bbai_ui_render(
				...
				array(
					'value' => '~2h',
					'label' => __( 'time saved', 'beepbeep-ai-alt-text-generator' ),
				)
			);
			bbai_ui_render(
				'stat-card',
				array(
					...
					'root_class' => 'bbai-analytics-metric-card--warn',
				)
			);
		...
		<div class="bbai-ui-kit__group">
			...
			bbai_ui_render(
				...
				array(
					'variant' => 'neutral',
					'message' => __( 'Neutral notice copy.', 'beepbeep-ai-alt-text-generator' ),
				)
			);
			bbai_ui_render(
				'notice-strip',
				array(
					'variant' => 'info',
					'message' => __( 'Info notice copy.', 'beepbeep-ai-alt-text-generator' ),
				)
			);
			?>
		</div>
		...
		<div class="bbai-ui-kit__group">
			...
			$bbai_ins_chips       = array(
				array( 'label' => __( 'Chip A', 'beepbeep-ai-alt-text-generator' ) ),
				array( 'label' => __( 'Chip B', 'beepbeep-ai-alt-text-generator' ) ),
			);
		...
		<div class="bbai-ui-kit__group">
			...
			bbai_ui_render(
				...
				array(
					'phase' => 'open',
					'class' => 'bbai-ui-kit-workspace-shell',
				)
			);
			bbai_ui_render(
				'workspace-grid',
			...
			bbai_ui_render(
				...
				array(
					'phase' => 'open',
					'tag'   => 'div',
					'class' => 'bbai-ui-kit-workspace-main',
				)
			);
			bbai_ui_render(
				'section-header',
