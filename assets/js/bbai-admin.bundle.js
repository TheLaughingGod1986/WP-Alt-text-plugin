 ...
 * @package BeepBeep_AI
 * @since 5.0.0
 * @generated 2026-03-09T14:06:33.138Z
 */
...
(function($) {
    ...
    window.bbaiHandleLimitReached = function(errorData) {
        ...
        var resetMessage = __('Your next 25 free credits will be available at the next monthly reset.', 'beepbeep-ai-alt-text-generator');

        if (resetMeta.daysUntilReset !== null) {
            if (resetMeta.daysUntilReset <= 0) {
                resetMessage = __('Your next 25 free credits should be available today.', 'beepbeep-ai-alt-text-generator');
            } else {
                resetMessage = sprintf(
                    _n(
                        'Your next 25 free credits will be available in %d day.',
                        'Your next 25 free credits will be available in %d days.',
...
(function($) {
    ...
    window.showSuccessModal = function(data) {
        ...
        if (data.failures > 0) {
            ...
            $summary.find('.bbai-modal-success__summary-icon').text('✓');
            $summary.find('.bbai-modal-success__summary-text').text('Nice work — your media library is looking great.');
            $warningsBtn.hide();
        }
