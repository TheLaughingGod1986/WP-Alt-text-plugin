/**
 * OpptiAI Context-Aware Upgrade Prompts
...
(function() {
    ...
    const bbaiContextUpgrades = {
        ...
        showScrollDepthPrompt: function() {
            const message = 'You\'re exploring OpptiAI! Upgrade to Growth to unlock all features and maximize your SEO impact.';
            this.showUpgradeToast(message, {
                action: () => {
                    const upgradeBtn = document.querySelector('[data-action="show-upgrade-modal"]');
                    if (upgradeBtn) upgradeBtn.click();
        ...
        showTimeBasedPrompt: function() {
            const message = 'You\'ve been using OpptiAI for a while. Upgrade to Growth for unlimited monthly credits!';
            this.showUpgradeToast(message, {
                action: () => {
                    const upgradeBtn = document.querySelector('[data-action="show-upgrade-modal"]');
                    if (upgradeBtn) upgradeBtn.click();
