...
while true; do
    ...
    docker exec wp-alt-text-plugin-wordpress-1 php /var/www/html/wp-content/plugins/ai-alt-gpt/scripts/check-and-process-queue.php 2>&1 | grep -E "(Queue Status|Pending|Processing|Failed|Completed|✓|⚠|Error)"
