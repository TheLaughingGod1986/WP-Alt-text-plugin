...
- Added **Contributing** section to `README.md`
  - Quick links to contribution guides
  - Ways to contribute
...
## 📋 Contribution Checklist for Maintainers

Before accepting contributions, verify:

- [ ] Contributor has read CONTRIBUTING.md
