...
class Input_Validator {
	 ...
	 */
	public static function array_param( \WP_REST_Request $request, $param, $default = array() ) {
		$value = $request->get_param( $param );
	...
	public static function period( $period ) {
		$allowed = array( 'day', 'week', 'month', 'year', 'all' );
	...
	public static function scope( $scope ) {
		$allowed = array( 'missing', 'all', 'generated', 'manual', 'reviewed' );
