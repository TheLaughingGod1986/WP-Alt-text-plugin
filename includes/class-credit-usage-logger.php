...
class Credit_Usage_Logger {
	...
	/**
	 * Reduce IP precision before persistence to minimize PII retention.
	 *
	...
	/**
	 * Build normalized shared filter state for usage queries.
	 *
	...
	/**
	 * Prepared values for shared usage filters.
	 *
