...
class Privacy {
	...
	public static function eraser( string $email_address, int $page = 1 ): array {
		...
		if ( ! $items_removed && ! $items_retained ) {
			$messages[] = __( 'No OpptiAI Alt Text data found for this email address.', 'beepbeep-ai-alt-text-generator' );
		}
	...
	private static function export_contact_submissions( string $email_address, int $user_id, int $page, bool &$done ): array {
		...
		foreach ( $rows as $row ) {
			$items[] = [
				...
				'group_label' => __( 'OpptiAI Alt Text Contact Submissions', 'beepbeep-ai-alt-text-generator' ),
	...
	private static function export_trial_usage_summary(): array {
		...
		return [
			[
				...
				'group_label' => __( 'OpptiAI Alt Text Trial Usage', 'beepbeep-ai-alt-text-generator' ),
			...
			if ( class_exists( '\BeepBeepAI\AltTextGenerator\Credit_Usage_Logger' ) ) {
				...
				if ( ! empty( $summary ) && (int) $summary['events'] > 0 ) {
					$items[] = [
						...
						'group_label' => __( 'OpptiAI Alt Text Credit Usage', 'beepbeep-ai-alt-text-generator' ),
			...
			if ( class_exists( '\BeepBeepAI\AltTextGenerator\Usage\Usage_Logs' ) ) {
				...
				if ( ! empty( $summary ) && (int) $summary['events'] > 0 ) {
					$items[] = [
						...
						'group_label' => __( 'OpptiAI Alt Text Usage Logs', 'beepbeep-ai-alt-text-generator' ),
