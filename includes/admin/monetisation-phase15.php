...
function bbai_monetisation_canonical_tier_from_slug( string $slug ): string {
	...
	if ( in_array( $slug, array( 'agency', 'enterprise' ), true ) ) {
 ...
 */
function bbai_monetisation_message( string $key, array $vars = array() ): string {
	$templates = array(
		'roi_minutes'         => sprintf(
