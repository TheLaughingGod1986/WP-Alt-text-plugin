...
if ( ! function_exists( 'bbai_copy_td' ) ) {
	...
	function bbai_copy_cta_fix_missing_alt(): string {
		return __( 'Optimise ALT text', 'beepbeep-ai-alt-text-generator' );
	}
	...
	function bbai_copy_helper_generate_then_review(): string {
		return __( 'Optimise ALT text, then review descriptions that need improvement.', 'beepbeep-ai-alt-text-generator' );
	}
