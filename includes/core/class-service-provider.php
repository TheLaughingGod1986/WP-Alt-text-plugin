...
class Service_Provider {
	...
	private static function register_services( Container $container ): void {
		...
		$container->singleton(
			'service.auth',
			function ( $c ) {
				return new \BeepBeepAI\AltText\Services\Authentication_Service(
					$c->get( 'api.beepbeep' ),
					$c->get( 'event_bus' )
				);
			}
		...
		$container->singleton(
			'service.license',
			function ( $c ) {
				return new \BeepBeepAI\AltText\Services\License_Service(
					$c->get( 'api.beepbeep' ),
					$c->get( 'event_bus' )
				);
			}
		...
		$container->singleton(
			'service.usage',
			function ( $c ) {
				return new \BeepBeepAI\AltText\Services\Usage_Service(
					$c->get( 'api.beepbeep' )
				);
			}
		);
		...
		$container->singleton(
			'service.generation',
			function ( $c ) {
				return new \BeepBeepAI\AltText\Services\Generation_Service(
					$c->get( 'api.beepbeep' ),
					$c->get( 'service.usage' ),
					$c->get( 'event_bus' ),
					$c->get( 'core' )
		...
		$container->singleton(
			'service.queue',
			function ( $c ) {
				return new \BeepBeepAI\AltText\Services\Queue_Service(
					$c->get( 'event_bus' )
				);
			}
		);
	...
	private static function register_controllers( Container $container ): void {
		...
		$container->singleton(
			'controller.auth',
			function ( $c ) {
				return new \BeepBeepAI\AltText\Controllers\Auth_Controller(
					$c->get( 'service.auth' )
				);
			}
		);
		...
		$container->singleton(
			'controller.license',
			function ( $c ) {
				return new \BeepBeepAI\AltText\Controllers\License_Controller(
		...
		$container->singleton(
			...
			function ( $c ) {
				return new \BeepBeepAI\AltText\Controllers\Generation_Controller(
		...
		$container->singleton(
			'controller.queue',
			function ( $c ) {
				return new \BeepBeepAI\AltText\Controllers\Queue_Controller(
					$c->get( 'service.queue' )
				);
			}
		);
