...
trait Api_Token {
	...
	public function set_token( $token ) {
		...
		foreach ( array( 'beepbeepai_jwt_token', 'opptibbai_jwt_token' ) as $legacy ) {
	...
	public function get_user_data() {
		$user_data = get_option( $this->user_option_key, array() );
		if ( empty( $user_data ) ) {
			$user_data = get_option( 'opptibbai_user_data', array() );
			if ( ! empty( $user_data ) ) {
