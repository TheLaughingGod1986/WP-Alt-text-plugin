...
function bbai_growth_seo_engine_data(): array {
	...
	$data = array(
		...
		'landing_page_templates'   => array(
			...
			'proof_points'  => array( 'WCAG-friendly workflow', 'Image SEO & Google Images', 'Bulk + on-upload automation on paid plans' ),
		...
		'distribution_channels'    => array(
			...
			'reddit'                => array( 'r/wordpress', 'r/SEO', 'r/woocommerce' ),
