...
// Anonymous trial identifiers and bbai_trial_usage_* counters are intentionally
// retained so deleting/reinstalling the plugin cannot reset the 5-generation trial.
